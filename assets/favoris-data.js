...
// synchronisation serveur (pas de collection dédiée côté Wix). C'est une vraie
// limite (les favoris ne suivent pas l'acheteur d'un appareil à l'autre) mais
// cohérente avec le choix fait pour ce parcours (pas de mot de passe, pas de
// compte) - à revoir si une collection Favoris est ajoutée plus tard.
